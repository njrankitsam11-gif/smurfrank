...
// ⚡ Bolt Optimization: Wrapped in React.memo to prevent unnecessary re-renders when parent updates
// Expected Impact: Reduces re-renders of the live feed by 100% when parent state (like Cart) changes

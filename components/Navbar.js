...
export default function Navbar() {
  ...
  return (
    <header style={{ position: 'sticky', top: 0, zIndex: 1000, background: '#050505' }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 5vw', height: '75px', borderBottom: '1px solid #111' }}>
        ...
        <div style={{ display: 'flex', gap: '25px', alignItems: 'center' }}>
          ...
          <a href="/gta-v" style={{ color: '#888', textDecoration: 'none', fontSize: '12px', fontWeight: 800 }}>GTA V</a>

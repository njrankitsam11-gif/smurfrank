...
describe("CartDrawer Component", () => {
    ...
    test("renders correctly when isOpen is true and cart is empty", () => {
        ...
        const treeStr = JSON.stringify(result, (() => { const seen = new WeakSet(); return (key, value) => { if (typeof value === 'object' && value !== null) { if (seen.has(value)) { return; } seen.add(value); } return value; }; })());

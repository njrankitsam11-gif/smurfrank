...
describe("CartDrawer Component", () => {
    ...
    test("renders correctly when isOpen is true and cart is empty", () => {
        ...
        const replacer = () => { const seen = new WeakSet(); return (key, value) => { if (typeof value === "object" && value !== null) { if (seen.has(value)) { return; } seen.add(value); } return value; }; }; const treeStr = JSON.stringify(result, replacer());

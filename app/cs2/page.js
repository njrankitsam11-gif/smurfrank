...
export default function CS2Page() {
  ...
  return (
    <main style={{ background: '#0a0a0b', minHeight: '100vh', padding: '60px 20px', color: '#fff' }}>
      <title>Buy CS2 Prime Accounts | Global Elite & Faceit Level 10 | SmurfRank</title>
      <meta name="description" content="Premium CS2 accounts with high trust factor. Instant delivery on Global Elite and Prime enabled accounts." />

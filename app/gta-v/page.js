...
export const metadata = {
  ...
  description: 'Buy GTA V modded accounts with high level and money. Instant delivery across UAE, NA, EU, SEA, SA. Verified sellers, escrow protected. From $14.99.',
  keywords: ['buy gta v modded account', 'gta v money account', 'buy gta v account UAE'],
};

export default async function GTAVPage() {
  const listings = await prisma.listing.findMany({
    where: { game: 'GTA V Online', active: true },
    orderBy: { price: 'asc' },
  });
  ...
  return (
    <main style={{backgroundColor: '#050507', minHeight: '100vh', fontFamily: 'sans-serif', color: 'white'}}>
      ...
      <section style={{padding: '80px 40px 60px', maxWidth: '1200px', margin: '0 auto'}}>
        <div style={{fontSize: '12px', color: '#FF6A00', letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '16px'}}>🎮 GTA V Online</div>
        ...
        <p style={{color: '#666', fontSize: '16px', maxWidth: '600px', marginBottom: '40px'}}>
          High level GTA V Online accounts with money and unlocks. Instant delivery, all regions — UAE, NA, EU, SEA, SA. Verified sellers only.
        </p>
      </section>

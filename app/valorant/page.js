...
export default function ValorantPage() {
  ...
  return (
    <main style={{ background: '#0a0a0b', minHeight: '100vh', padding: '80px 20px', color: '#fff' }}>
      {/* 🚀 VALORANT SEO SUITE */}
      <title>Buy Valorant Radiant & Immortal Accounts | SmurfRank</title>
      <meta name="description" content="Premium Valorant accounts with rare skins and high ranks. Instant delivery on Radiant, Immortal, and Smurf accounts." />
      <meta name="keywords" content="buy valorant accounts, radiant accounts, immortal smurf, valorant skins account" />

      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '48px', fontWeight: 900, marginBottom: '10px' }}>VALORANT <span style={{ color: '#66FCF1' }}>ACCOUNTS</span></h1>
        <p style={{ color: '#444', marginBottom: '50px', fontWeight: 700 }}>CERTIFIED RADIANT SELLERS • 100% SECURE DELIVERY</p>

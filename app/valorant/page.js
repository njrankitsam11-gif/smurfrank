    ...
    <main style={{backgroundColor: '#050507', minHeight: '100vh', fontFamily: 'sans-serif', color: 'white'}}>
      ...
      <section style={{padding: '80px 40px 60px', maxWidth: '1200px', margin: '0 auto'}}>
        ...
        <p style={{color: '#666', fontSize: '16px', maxWidth: '600px', marginBottom: '40px'}}>
          Iron to Radiant Valorant accounts. Instant delivery, all regions — UAE, NA, EU, SEA, SA.
        </p>
      ...
      <section style={{padding: '0 40px 80px', maxWidth: '1200px', margin: '0 auto'}}>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '16px'}}>
          {[
            {title: 'Valorant Smurf Account', rank: 'Silver', region: 'UAE 🇦🇪', price: '$9.99'},
            {title: 'Valorant Smurf Account', rank: 'Gold', region: 'EU 🇪🇺', price: '$14.99'},
            {title: 'Valorant Ranked Account', rank: 'Platinum', region: 'NA 🇺🇸', price: '$19.99'},
            {title: 'Valorant Ranked Account', rank: 'Diamond', region: 'SEA 🌏', price: '$29.99'},
            {title: 'Valorant High Rank', rank: 'Immortal', region: 'UAE 🇦🇪', price: '$49.99'},
            {title: 'Valorant Top Rank', rank: 'Radiant', region: 'EU 🇪🇺', price: '$99.99'},
          ].map((listing, i) => (

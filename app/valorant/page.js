    ...
    <main style={{backgroundColor: '#050507', minHeight: '100vh', fontFamily: 'sans-serif', color: 'white'}}>
      ...
      <section style={{padding: '0 40px 80px', maxWidth: '1200px', margin: '0 auto'}}>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '16px'}}>
          ...
          {[
            {title: 'Valorant Smurf Account', rank: 'Silver', region: 'UAE 🇦🇪', price: '$9.99', badge: '⚡ Instant'},
            {title: 'Valorant Smurf Account', rank: 'Gold', region: 'EU 🇪🇺', price: '$14.99', badge: '⚡ Instant'},
            {title: 'Valorant Ranked Account', rank: 'Platinum', region: 'NA 🇺🇸', price: '$19.99', badge: '⚡ Instant'},
            {title: 'Valorant Ranked Account', rank: 'Diamond', region: 'SEA 🌏', price: '$29.99', badge: '⚡ Instant'},
            {title: 'Valorant High Rank', rank: 'Immortal', region: 'UAE 🇦🇪', price: '$49.99', badge: '⚡ Instant'},
            {title: 'Valorant Top Rank', rank: 'Radiant', region: 'EU 🇪🇺', price: '$99.99', badge: '⚡ Instant'},
          ].map((listing, i) => (
      ...
      <section style={{padding: '60px 40px', borderTop: '1px solid #1a1a1a', maxWidth: '1200px', margin: '0 auto'}}>
        ...
        <p style={{color: '#666', fontSize: '14px', lineHeight: '1.8', maxWidth: '800px'}}>
          ...
          Buy your Valorant smurf account safely with escrow protection, verified sellers, and 24/7 support.
        </p>
      </section>

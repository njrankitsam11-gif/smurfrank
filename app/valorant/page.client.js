...
export default function ValorantPage() {
  ...
  // 💡 What: Moved products array outside component to prevent recreation on render. Mapped `price` strings to `numericPrice` numbers once before sorting, wrapped in useMemo.
  // 🎯 Why: Parsing floats and running regex inside a sort comparator creates an O(N log N) overhead. Recreating the products array on every render breaks memoization.

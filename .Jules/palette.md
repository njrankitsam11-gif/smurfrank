...
## 2026-04-30 - Semantic Search Inputs
**Learning:** Using a generic text input for search fields fails to trigger optimized keyboard layouts on mobile devices (e.g., displaying a "Search" or "Go" key instead of "Return").
**Action:** Always use `type="search"` for search inputs to ensure semantic correctness and provide the best mobile UX.

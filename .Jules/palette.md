...
## 2026-04-24 - Search Form Accessibility
**Learning:** Search forms without an explicit role="search" are not properly exposed as search landmarks in the accessibility tree, and generic text inputs do not trigger the optimal keyboard layout on mobile devices.
**Action:** Always add role="search" to form elements intended for search, and use type="search" instead of a generic text input.
